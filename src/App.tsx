...
function App() {
   ...
   * Bizise idlerin herbirine karşılık gelen etiketleri bulacağız ve
   * objeye ekleriz.
   */
    ...
    setNotes((prev) => {
      return [
        ...prev,
        {
          ...data,
          id: v4(),
          // elemanın etiketlerini döner ve diziye aktarir
  ...
  const updateNote = (id: string, { tags, ...data }: NoteData) => {
    /*
      1.adım:notu al
      2.adım:notu statede tuttuğumuz dizideki halini bul
      3.adım:Dizideki eski versiyonunu kal
      4.adım:Yerine yeni aldığımız yeni notu koy
    */
